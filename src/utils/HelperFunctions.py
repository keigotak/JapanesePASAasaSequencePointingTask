...
def get_argparser():
    ...
    parser.add_argument('--model', type=str, default='mlp', choices=['mlp', 'lstm', 'pointer', 'combination', 'lstmnd', 'lstmnz', 'slmhatten', 'bertsl', 'bertptr', 'bertslnr', 'bertptrnr', 'elmosl', 'elmosp'])
