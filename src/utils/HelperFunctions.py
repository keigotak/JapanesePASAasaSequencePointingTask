...
def get_argparser():
    ...
    parser.add_argument('--task', type=str, default='sl', choices=['sl', 'sp'])
    ...
    parser.add_argument('--emb', type=str, default='original', choices=['original', 'w2v', 'fasttext', 'cbow', 'cbow-retrofitting', 'glove', 'glove-retrofitting', 'skipgram', 'skipgram-retrofitting', 'elmo', 'bert'])
