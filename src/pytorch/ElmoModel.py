...
class ElmoModel:
    def __init__(self, device='cpu', with_train=False):
        ...
        if self.with_train:
            ...
            self.embedding = Elmo(option_file, weight_file, num_output_representations=2)
            self.embedding_dim = self.embedding.config['encoder']['projection_dim']
