...
def train_model(run_mode='rinna-gpt2'):
    ...
    test_tt, test_ff = 0, 0
    i = 0
    # s1 = 'ジムはジャックに会って喜んだ。ジャックはジムの一日を明るくした。'
    # s2 = 'ジムはジャックに会って喜んだ。ジムはジムの一日を明るくした。'
    # l = 0

    s1 = '検事は被告人らを厳しく攻撃した。被告人らは依頼人を有罪にしようとしているのだ。'
    s2 = '検事は被告人らを厳しく攻撃した。検事は依頼人を有罪にしようとしているのだ。'
    l = 0
