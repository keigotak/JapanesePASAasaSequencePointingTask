...
def get_bertsl_bccwj():
    with Path("../../results/pasa-bertsl-20200419-151541-906623/bsl_20200419-151541_model-0_epoch8-f0.7877.h5.pkl").open('rb') as f:
        items0 = pickle.load(f)
    with Path("../../results/pasa-bertsl-20200419-151543-725292/bsl_20200419-151543_model-0_epoch8-f0.7916.h5.pkl").open('rb') as f:
        items1 = pickle.load(f)
    with Path("../../results/pasa-bertsl-20200419-151542-553196/bsl_20200419-151542_model-0_epoch8-f0.7918.h5.pkl").open('rb') as f:
        items2 = pickle.load(f)
    with Path("../../results/pasa-bertsl-20200419-151542-129443/bsl_20200419-151542_model-0_epoch6-f0.7916.h5.pkl").open('rb') as f:
        items3 = pickle.load(f)
    with Path("../../results/pasa-bertsl-20200420-101530-395702/bsl_20200420-101530_model-0_epoch9-f0.7894.h5.pkl").open('rb') as f:
        items4 = pickle.load(f)
    return items0, items1, items2, items3, items4
...
def get_bertsp_bccwj(mode="global"):
    items0, items1, items2, items3, items4 = [], [], [], [], []
    if mode == "none":
        with Path("../../results/pasa-bertptr-20200419-151541-252443/bsp_20200419-151541_model-0_epoch7-f0.7936.h5.pkl").open('rb') as f:
            items0 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-151541-522425/bsp_20200419-151541_model-0_epoch9-f0.7937.h5.pkl").open('rb') as f:
            items1 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-151542-522073/bsp_20200419-151542_model-0_epoch11-f0.7924.h5.pkl").open('rb') as f:
            items2 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-151542-441209/bsp_20200419-151542_model-0_epoch12-f0.7922.h5.pkl").open('rb') as f:
            items3 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-151542-348408/bsp_20200419-151542_model-0_epoch11-f0.7945.h5.pkl").open('rb') as f:
            items4 = pickle.load(f)
    elif mode == "global":
        with Path("../../results/pasa-bertptr-20200419-182745-898846/bsp_20200419-182745_model-0_epoch11-f0.7939.h5.pkl").open(
            'rb') as f:
            items0 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-182757-754887/bsp_20200419-182757_model-0_epoch9-f0.7943.h5.pkl").open(
            'rb') as f:
            items1 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-182747-610892/bsp_20200419-182747_model-0_epoch11-f0.7955.h5.pkl").open(
            'rb') as f:
            items2 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-182806-105741/bsp_20200419-182806_model-0_epoch9-f0.7950.h5.pkl").open(
            'rb') as f:
            items3 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-182806-354122/bsp_20200419-182806_model-0_epoch8-f0.7943.h5.pkl").open(
            'rb') as f:
            items4 = pickle.load(f)
    elif mode == "local":
        with Path("../../results/pasa-bertptr-20200419-204136-400021/bsp_20200419-204136_model-0_epoch9-f0.7955.h5.pkl").open('rb') as f:
            items0 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-204241-960472/bsp_20200419-204241_model-0_epoch9-f0.7944.h5.pkl").open('rb') as f:
            items1 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-204241-360608/bsp_20200419-204241_model-0_epoch12-f0.7940.h5.pkl").open('rb') as f:
            items2 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-204242-504153/bsp_20200419-204242_model-0_epoch8-f0.7924.h5.pkl").open('rb') as f:
            items3 = pickle.load(f)
        with Path("../../results/pasa-bertptr-20200419-204241-858968/bsp_20200419-204241_model-0_epoch8-f0.7963.h5.pkl").open('rb') as f:
            items4 = pickle.load(f)
    return items0, items1, items2, items3, items4
...
85.61 & - & 91.39 & 91.63 & 95.29 & 75.31 & 55.75 & 58.34 & 47.75 & 10.89
[spn_ntc]
...
85.80 & - & 91.75 & 91.99 & 95.55 & 76.27 & 56.92 & 59.80 & 46.59 & 11.85
[spg_ntc]
...
85.56 & - & 91.59 & 91.82 & 95.45 & 75.63 & 56.46 & 59.40 & 45.87 & 8.66
[spl_ntc]
...
85.70 & - & 91.63 & 91.79 & 95.52 & 76.09 & 56.94 & 59.57 & 48.04 & 11.49
[bertsl_ntc]
...
87.52 & - & 92.56 & 93.43 & 96.46 & 73.95 & 62.68 & 65.11 & 56.20 & 16.14
[bertspn_ntc]
...
87.82 & - & 92.74 & 93.43 & 96.22 & 76.66 & 63.91 & 66.17 & 58.45 & 16.79
[bertspg_ntc]
...
87.77 & - & 92.73 & 93.47 & 96.26 & 75.97 & 63.64 & 65.98 & 57.58 & 16.24
[bertspl_ntc]
...
87.81 & - & 92.70 & 93.48 & 96.25 & 75.80 & 63.90 & 66.14 & 58.72 & 15.56
[sl_bccwj]
...
78.72 & - & 84.06 & 85.27 & 84.82 & 77.92 & 52.29 & 56.80 & 43.03 & 17.65
[spn_bccwj]
...
78.50 & - & 84.26 & 85.38 & 85.12 & 78.14 & 52.53 & 57.18 & 43.12 & 15.91
[spg_bccwj]
...
78.32 & - & 84.12 & 85.31 & 84.82 & 78.17 & 51.89 & 56.06 & 42.63 & 17.87
[spl_bccwj]
...
78.25 & - & 83.91 & 85.14 & 84.68 & 77.63 & 52.42 & 56.98 & 41.96 & 18.18
[bertsl_bccwj]
All: 0.8120627000054239, Dep: 0.8591586098771884, Zero: 0.5816554809843401 / tp: [6830 4550 1772 1478  299   43], fp: [908 715 408 591 216  51], fn: [1107  701  473 1211  333  216]
0.871451355661882, 0.8653480410802586, 0.8009039548022598, 0.6212694409415721, 0.5213600697471665, 0.24362606232294615
81.21 & - & 85.92 & 87.15 & 86.53 & 80.09 & 58.17 & 62.13 & 52.14 & 24.36
[bertspn_bccwj]
All: 0.8121450297434792, Dep: 0.8590253767369038, Zero: 0.5907900816263669 / tp: [6898 4499 1771 1581  300   37], fp: [994 674 375 787 165  43], fn: [1043  758  478 1108  332  222]
0.8713446598875766, 0.8627037392138062, 0.8059158134243458, 0.6252719003361676, 0.5469462169553327, 0.21828908554572268
81.21 & - & 85.90 & 87.13 & 86.27 & 80.59 & 59.08 & 62.53 & 54.69 & 21.83
[bertspg_bccwj]
All: 0.8099681809674055, Dep: 0.8585911099558097, Zero: 0.5840253661482713 / tp: [6880 4545 1787 1596  303   35], fp: [1040  690  375  848  212   44], fn: [1064  718  465 1094  332  225]
0.8673726676752395, 0.8658792150885882, 0.80969642048029, 0.6217374366965328, 0.5269565217391305, 0.20648967551622416
81.00 & - & 85.86 & 86.74 & 86.59 & 80.97 & 58.40 & 62.17 & 52.70 & 20.65
[bertspl_bccwj]
All: 0.8105386541637807, Dep: 0.8573835833954437, Zero: 0.5941009133103758 / tp: [6861 4549 1819 1617  326   41], fp: [1009  731  406  813  237   55], fn: [1099  723  433 1077  310  219]
0.8668351231838282, 0.8622062168309326, 0.8125977216886309, 0.6311475409836066, 0.5437864887406172, 0.23033707865168537
81.05 & - & 85.74 & 86.68 & 86.22 & 81.26 & 59.41 & 63.11 & 54.38 & 23.03
...
81.10 & - & 85.76 & 86.99 & 86.36, 79.86 & 58.24 & 62.14 & 52.80 & 21.21
[bertspn_bccwj]
...
81.30 & - & 85.95 & 87.21 & 86.29 & 80.62 & 59.26 & 62.76 & 54.79 & 21.83
[bertspg_bccwj]
...
81.06 & - & 85.90 & 86.79 & 86.61 & 81.00 & 58.53 & 62.33 & 52.79 & 20.65
[bertspl_bccwj]
...
81.13 & - & 85.79 & 86.75 & 86.25 & 81.29 & 59.55 & 63.30 & 54.44 & 23.03
